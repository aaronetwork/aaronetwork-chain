...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_ff47675e3850573e, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ff47675e3850573e, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "aaronetwork.aaronetwork.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "aaronetwork.aaronetwork.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("aaronetwork/aaronetwork/tx.proto", fileDescriptor_ff47675e3850573e) }

var fileDescriptor_ff47675e3850573e = []byte{
	// 321 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x52, 0x48, 0x4c, 0x2c, 0xca,
	0xcf, 0x4b, 0x2d, 0x29, 0xcf, 0x2f, 0xca, 0xd6, 0x47, 0x66, 0x97, 0x54, 0xe8, 0x15, 0x14, 0xe5,
	...
	0x70, 0x24, 0x19, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x0c, 0x03, 0x5e, 0x0c, 0x64, 0x02, 0x00,
	0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/aaronetwork.aaronetwork.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aaronetwork.aaronetwork.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "aaronetwork.aaronetwork.Msg",
	...
	Metadata: "aaronetwork/aaronetwork/tx.proto",
}
